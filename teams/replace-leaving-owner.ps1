# --------------------------------------------------------------
# Replace leaving Team Owner with other user
# Blog post: https://svrooij.io/2022/09/13/replace-teams-owner/
# --------------------------------------------------------------
...
# --------------------------------------------------------------
# Replace user in all Teams he/she owns
# --------------------------------------------------------------

# Change accordingly
$tenantId = "21009bcd-06df-4cdf-b114-e6a326ef3368";
# User ID of leaving user
